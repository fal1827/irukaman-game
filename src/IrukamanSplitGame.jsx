          ...
          >
            {[...Array(のこり)].map((_, i) => (
              <img
                ...
                alt="いるかまん"
                className={`w-16 h-16 object-contain cursor-pointer ${エフェクト中 && i === えらばれたこ ? "ぽちゃん" : ""
                  }`}
              />
            ))}
          </div>
            ...
            {["ひだり", "みぎ"].map((side) => {
              ...
              return (
                <div
                  ...
                  className="mt-4 p-2 border-4 border-blue-300 bg-gradient-to-t from-blue-300 to-blue-100 rounded-xl w-28 h-28 flex flex-col items-center justify-center shadow-lg"
                >
